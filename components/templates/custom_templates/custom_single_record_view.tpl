            ...
            <div class="form-static {if $Grid.FormLayout->isHorizontal()}form-horizontal col-lg-8{else}col-md-8 col-md-offset-2{/if}">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#common-{$Grid.FormId}" aria-controls="common-{$Grid.FormId}" role="tab" data-toggle="tab">
                            Common
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#dimensions-display-{$Grid.FormId}" aria-controls="dimensions-display-{$Grid.FormId}" role="tab" data-toggle="tab">
                            Dimensions & Display
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#hardware-software-{$Grid.FormId}" aria-controls="hardware-software-{$Grid.FormId}" role="tab" data-toggle="tab">
                            Hardware & Software
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#camera-battery-{$Grid.FormId}" aria-controls="camera-battery-{$Grid.FormId}" role="tab" data-toggle="tab">
                            Camera & Battery
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="common-{$Grid.FormId}">
                    ...
                    <div role="tabpanel" class="tab-pane" id="dimensions-display-{$Grid.FormId}">
                    ...
                    <div role="tabpanel" class="tab-pane" id="hardware-software-{$Grid.FormId}">
                    ...
                    <div role="tabpanel" class="tab-pane" id="camera-battery-{$Grid.FormId}">
