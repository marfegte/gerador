...
return array(
    ...
    // Data Grid
	'filmes_torrent.php' => array(
        'description' => 'Melhor Filmes Torrent.',
        'class_attribute' => ''
		
	),	
	
	'arrow_7_temporada.php' => array(
        'description' => 'Oliver preso há cinco meses e Starcity sem vigilantes desde a prisão do herói. Mas não por muito tempo! Há um novo vigilante na cidade.',
        'class_attribute' => ''
    ),
	
	'the_flash_5_temporada.php' => array(
        'description' => 'You can view the linked record of a lookup column.',
        'class_attribute' => ''
    ),
	
	'dragon_ball_heroes.php' => array(
        'description' => 'Melhor Séries Torrent. ',
        
        'class_attribute' => ''
    ),
	
	'dragon_ball_super.php' => array(
        'description' => 'Melhor Séries Torrent. ',
    ...
    'agents_of_shield_5_temporada.php' => array(
        'description' => 'Coulson e seus agentes foram enviados para o espaço, onde eles enfrentarão a raça Kree.',
    ...
    'filtering_custom_filter_advanced.php' => array(
        ...
        'class_attribute' => 'pro custom recently-added'
    ),
