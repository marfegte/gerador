...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'custom_templates/custom_menu_learn_more.tpl', 'smarty_include_vars' => array('DemoName' => 'Quasar','DemoTag' => 'Feature','DemoProjectLink' => 'feature_demo_project')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</ul>